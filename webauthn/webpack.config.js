...
module.exports = (env, argv) => {
    let config = {
        ...
        output: {
            ...
            filename: 'mfa-factors-webauthn.bundle.js',
            chunkFilename: '[name].mfa-factors-webauthn.[chunkhash:6].js'
        },
        resolve: {
        ...
        plugins: [
            new ModuleFederationPlugin(getModuleFederationConfig(packageJson, {
                library: {type: 'assign', name: 'appShell.remotes.mfaFactorsWebauthn'}
            })),
