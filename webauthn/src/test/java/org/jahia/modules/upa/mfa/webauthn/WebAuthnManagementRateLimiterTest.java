...
/**
 * Verifies the pure window/counter arithmetic of the WebAuthn management rate limiter (mirrors
 * {@code TotpManagementRateLimiterTest}). The JCR persistence layer (cluster-safe lockout state)
 * is exercised end-to-end by the Cypress suite; here we pin the sliding-window decision logic.
 */
public class WebAuthnManagementRateLimiterTest {
